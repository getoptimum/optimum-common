...
func NewRotatingFileWriter(filePath string, maxSize int64) (*RotatingFileWriter, error) {
	...
	if err := os.MkdirAll(dir, 0755); err != nil { //nolint:gosec // directory permissions
		return nil, fmt.Errorf("failed create logs dir: %w", err)
	}

	// Open or create the file
	f, err := os.OpenFile(filePath, os.O_CREATE|os.O_WRONLY|os.O_APPEND, 0644) //nolint:gosec // log file permissions
	if err != nil {
...
func (r *RotatingFileWriter) rotate() error {
	...
	// Create new file
	f, err := os.OpenFile(r.filePath, os.O_CREATE|os.O_WRONLY|os.O_TRUNC, 0644) //nolint:gosec // log file permissions
	if err != nil {
